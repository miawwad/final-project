...
const questions = [
    { 
      ...
      { 
        category: 'Lit',
        difficulty: 'Easy',
        question: 'Which Shakespeare play features the characters Rosalind and Orlando?',
      ...
      { 
        category: 'Lit',
        difficulty: 'Easy',
        question: 'What novel is the source of the quote, "All animals are equal, but some animals are more equal than others"?',
        options: ['The Jungle Book', 'Animal Farm', 'Watership Down', 'The Call of the Wild'],
      ...
      { 
        ...
        options: ['War and Peace', 'A Tale of Two Cities', 'Great Expectations', 'Les Misérables'],
        answer: 1, // Index of the correct answer in options array
      },
      { 
        category: 'Lit',
        ...
        options: ['Herman Melville', 'Nathaniel Hawthorne', 'Mark Twain', 'Henry James'],
        answer: 0, // Index of the correct answer in options array
      },
      { 
        category: 'Lit',
        ...
        options: ['To Kill a Mockingbird', 'The Scarlet Letter', 'East of Eden', 'Catch-22'],
        answer: 0, // Index of the correct answer in options array
      },
      { 
        category: 'Lit',
        difficulty: 'Easy',
        question: '"One Hundred Years of Solitude" is a book written by which author?',
      ...
      { 
        ...
        options: ['The Color Purple', 'Beloved', 'The Bluest Eye', 'Their Eyes Were Watching God'],
        answer: 0, // Index of the correct answer in options array
      },
      { 
        category: 'Lit',
        difficulty: 'Easy',
        question: 'What is the name of the fictional land where "The Lord of the Rings" is set?',
      ...
      { 
        ...
        options: ['George Orwell', 'Aldous Huxley', 'Philip K. Dick', 'Isaac Asimov'],
        answer: 1, // Index of the correct answer in options array
      },
      { 
        category: 'Lit',
        ...
        options: ['Romance', 'Science Fiction', 'Gothic Horror', 'Historical Fiction'],
        answer: 2, // Index of the correct answer in options array
      },
      { 
        category: 'Lit',
      ...
      { 
        ...
        options: ['Ralph Ellison', 'Richard Wright', 'James Baldwin', 'Langston Hughes'],
        answer: 0, // Index of the correct answer in options array
      },
      { 
        category: 'Lit',
        ...
        options: ['Isabel Allende', 'Gabriel García Márquez', 'Carlos Fuentes', 'Pablo Neruda'],
        answer: 1, // Index of the correct answer in options array
      },
      { 
        category: 'Lit',
        ...
        options: ['The Glass Menagerie', 'Death of a Salesman', 'Long Da\'s Journey Into Night', 'The Crucible'],
        answer: 0, // Index of the correct answer in options array
      },
];
