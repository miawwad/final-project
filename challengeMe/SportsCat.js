...
const questions = [
    { 
      ...
      { 
        category: 'Sports',
        difficulty: 'Easy',
        question: 'Who is considered one of the greatest basketball players of all time and played for the Chicago Bulls during the 1990s?',
      ...
      { 
        category: 'Sports',
        difficulty: 'Easy',
        question: 'In golf, what name is given to a score of three under par on a single hole?',
      ...
      { 
        category: 'Sports',
        difficulty: 'Easy',
        question: 'What is the maximum score possible with a single throw in darts?',
      ...
      { 
        category: 'Sports',
        difficulty: 'Easy',
        question: 'What term is used in baseball when a player hits the ball out of the park?',
      ...
      { 
        category: 'Sports',
        difficulty: 'Easy',
        question: 'Who has won the most Grand Slam titles in men\'s singles tennis as of 2021?',
      ...
      { 
        category: 'Sports',
        difficulty: 'Easy',
        question: 'What is the only team sport played on horseback included in the Olympics?',
      ...
      { 
        category: 'Sports',
        difficulty: 'Easy',
        question: 'Who was the first female gymnast to be awarded a perfect score of 10 at the Olympics?',
        options: ['Mary Lou Retton', 'Nadia Comaneci', 'Simone Biles', 'Shannon Miller'],
        answer: 1, // Index of the correct answer in options array
      },
      { 
        category: 'Sports',
        difficulty: 'Easy',
        question: 'Which sport did the ancient Greeks invent that involves throwing a disc?',
